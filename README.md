...
- [Milestone 3](#milestone-3---phần-mềm-desktop-hỗ-trợ-bán-cây-cảnh-cho-cửa-hàng-nhỏ)
...
- [Testing Document](https://docs.google.com/document/d/1kh2HNioCojY20D4kb3iqUx4DhJytbheBdiQf6-RuLHc/edit?usp=sharing)
- [Mô tả Cơ sở dữ liệu](https://docs.google.com/document/d/1bIAuwl1fBelzYLMbrfM5XIJyoZ-wDlrGZfac_sc9SzU/edit?usp=sharing)
- [Architecture Document](https://docs.google.com/document/d/1vKVmfa_STMEWTUNRw-rj-qx10GQ8lNln3-Nun_TDNq4/edit?usp=sharing)
## 2.Cấu trúc
...
| Liên hệ trực tiếp qua ứng dụng          | Cho phép người mua và người bán trao đổi trực tiếp trên ứng dụng | 3/3 giờ             | 10/10             |
...
| Liên hệ trực tiếp qua ứng dụng          | Cho phép người mua và người bán trao đổi trực tiếp trên ứng dụng | 3/3 giờ             | 10/10             |
| Xem nhanh và thêm vào giỏ hàng nhanh   | Sẽ có chỉ mục xem nhanh và icon giỏ hàng trên hình đại diện của sản phẩm cho phép thực hiện chức năng.| 3/3 giờ      | 10/10             |
| Đăng nhập/đăng ký   | Cho phép người dùng tạo tài khoản. Chia làm 3 loại người dùng:  người mua, admin| 3/3 giờ      | 10/10             |
| Đánh giá   | Cho phép người mua để lại đánh về những sản phẩm họ đã mua | 2/2 giờ      | 10/10             |
| Từ điển cây | Cho phép người dùng tìm kiếm sản phẩm theo alphabet |2.5/2.5|10/10|
| Người dùng có khả năng thuê khung bán trên cây của bản thân |Người dùng không cần phải đăng ký là nhà cung cấp mà có thể thuê 1 slot bán sản phẩm của nhà cung cấp để bán sản phẩm của mình|0.5/1|10/10|
| Lịch sử mua hàng |Các đơn hàng mà người mua đã thanh toán sẽ được lưu lại vào cơ sở dữ liệu|3/3|10/10|
| Hướng dẫn chăm sóc cây cảnh |Dành cho newbie không biết gì, hoặc chăm sóc loại cây đặc biệt.|2/2|10/10|
...
- Bấm vào đơn hàng sẽ xem được chi tiết đơn hàng.
...
- Người dùng có thể xem lại lịch sử order của mình trong trang cá nhân.
![alt text](image-30.png)
### 2.12 Hướng dẫn chăm sóc cây cảnh
- Người dùng có nhấn vào button Guide Category trên thanh Nav để xem các hướng dẫn về chăm sóc cây trồng
![alt text](image-32.png)
### 3. Advanced topic
- Tích hợp Web Browser.
- Thiết kế Toast thông báo của hệ thống bằng việc mượn JS.
## 4. Đánh giá tổng quan và nhận xét
**Tổng số giờ**: 30 giờ
**Tổng điểm tự đánh giá**: 10 điểm
**Ưu điểm**: Chịu khó tìm hiểu, kiên trì trong công việc.
